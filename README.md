...
- **Groq:** [https://console.groq.com](https://console.groq.com) → Create API Key  
- **OpenAI:** [https://platform.openai.com/account/api-keys](https://platform.openai.com/account/api-keys) → Create Secret Key  
